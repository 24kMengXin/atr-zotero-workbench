...
| 可安装候选 XPI | 部分完成 | v0.6.6 候选 XPI SHA-256 `ce5df85d328b115e337d92be1a23cb3d3b5cc4db6d87b85d2d9ac6d423eaa829`；53 项测试与静态合同通过；新增历史消费 mapping Note、每个旧 run 的 sidecar 计数/决策/边界，以及 portfolio 图的 164 项汇总。v0.6.4 的隔离 Zotero 9 运行验证仍覆盖 106 个来源、12 个知识 Collection、16 个研究 Collection、Reader 双 section、annotation/typed owner input 和便携四区/双图。XPI 连续两次构建字节完全一致；更新清单使用 SHA-256 且不打进 XPI | 发布 v0.6.6 后，仍需日常 profile 人工走查折叠密度与实际长文阅读体验 |
